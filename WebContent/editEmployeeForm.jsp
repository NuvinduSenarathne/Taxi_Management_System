...
<html lang="en">
  <head>
    ...
    <title>EasyTaxi | Edit Employee</title>
  </head>
  <body>
   ...
   <jsp:include page="/WEB-INF/views/layout.jsp"></jsp:include>
    ...
    <div class="dv_right">
      <div class="block2">
        ...
        <form class="editEmpForm" action="UpdateEmployee" method="post">
          <table>
            <tr>
              <th colspan="2">EDIT EMPLOYEE</th>
            </tr>
            <tr>
              <td><input type="hidden" name="empid" value="<c:out value='${employee.empid}' />" /></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td><input type="text" name="mobile" value="<c:out value='${employee.mobile}' />" /></td>
            </tr>
            <tr>
              <td><span>Salary</span></td>
              <td><input type="text" name="salary" value="<c:out value='${employee.salary}' />" /></td>
            </tr>
            <tr>
